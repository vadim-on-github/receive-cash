...
This app consists of 2 parts, frontend and backend. The backend is used for custom authentication and providing crypto
logos. The 2 parts are respectively located under `rc-fe` and `rc-be`.
